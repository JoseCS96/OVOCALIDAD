...
export default function EspecificacionesTecnicasPage(){
 ...
 return <PageContainer className="space-y-4">
  <div className="flex flex-wrap items-end justify-between gap-3"><div><p className="text-xs font-semibold uppercase tracking-[.16em] text-[var(--text-secondary)]">Gestión documental</p><h1 className="mt-1 text-2xl font-semibold">Especificaciones técnicas</h1><p className="mt-1 text-sm text-[var(--text-secondary)]">Administra documentos, versiones y especificaciones de producto.</p></div><Button onClick={()=>nav("/documentos/especificaciones/nueva")}><FilePlus2/>Nueva ET</Button></div>
