export type LoteListado = {
  ...
  lineaOrigenCodigo: string;
  lineaOrigenDescripcion: string;
  versionId: number;
  versionNumero: number;
  versionInicioVigencia: string;
  versionFinVigencia: string | null;
  estadoLoteId: number;
  ...
  intentoEvaluacion: number | null;
  estadoEvaluacionId: number | null;
  estadoEvaluacionCodigo: string | null;
  estadoEvaluacionDescripcion: string | null;
