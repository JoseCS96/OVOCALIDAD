...
import { BarChart3, Boxes, ClipboardCheck, FileCheck2, FileText, FlaskConical, Package, Settings, ShieldCheck } from "lucide-react";
...
const pages = [
  ...
  { path: "/documentos/especificaciones", title: "Especificaciones técnicas", eyebrow: "Gestión documental", description: "Administración estructurada de ET, versiones, criterios y características.", icon: FileText },
  ...
  { path: "/operacion/lotes", title: "Lotes", eyebrow: "Operación", description: "Seguimiento de lotes, producto, fase y estado dentro del flujo de calidad.", icon: FlaskConical },
